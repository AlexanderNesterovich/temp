...
public class Phonebook {
	...
	public static Phonebook getNew() throws ClassNotFoundException, SQLException {
		instance = new Phonebook();
		return instance;
	}
	...
	protected Phonebook() throws ClassNotFoundException, SQLException {
		...
		while (db_data.next()) {
			persons.put(db_data.getString("id"), new Person(db_data.getString("id"), db_data.getString("name"),
